...
export default function ChatWithAIHome({}: ChatWithAIProps) {
    ...
    try {
      ...
      const API_URL =
        process.env.NODE_ENV === "production"
          ? "/api/traffic/ask"
          : `${apiUrl}/api/v1/traffic-chat-bot-home/ask`;
  ...
  return (
    <div className="bg-white rounded-lg shadow-2xl overflow-hidden border border-gray-200">
      ...
      <div
        ...
        style={{ minHeight: "300px", maxHeight: "650px" }}
      >
        {messages.length === 0 && (
          <div className="text-center">
            <Bot className="w-20 h-20 mx-auto text-gray-300" />
      ...
      <div className="p-2 bg-gray-50 border-t border-gray-200">
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-8  bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-xl hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all flex items-center gap-3 font-bold shadow-lg"
          >
            {loading ? (
