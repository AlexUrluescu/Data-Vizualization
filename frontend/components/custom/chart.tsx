...
// Define specific colors for each chart type
const chartColors = {
  cars: "#3b82f6", // Blue
  population: "#10b981", // Green
...
export default function ChartAreaInteractive({
  ...
  // Get the color for this specific chart type
  const chartColor = chartColors[type];
  ...
  return (
    <Card
      style={{ width: flex ? "50%" : "100%" }}
      className="pt-0 transition-all duration-300 hover:shadow-lg"
    >
